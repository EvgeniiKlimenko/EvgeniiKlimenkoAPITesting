...
/** Class represents speller answer.
 * Auto-mapping.
 */
public class YandexSpellerAnswer {
    ...
    public String toString() {
        ...
        sb.append(',').append("s").append('=').append(((this.s == null) ? "<null>" : this.s)).append(',');
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.col == rhs.col) || ((this.col != null)
                && this.col.equals(rhs.col))) && ((this.code == rhs.code) || ((this.code != null)
                && this.code.equals(rhs.code)))) && ((this.s == rhs.s) || ((this.s != null) && this.s.equals(rhs.s))))
