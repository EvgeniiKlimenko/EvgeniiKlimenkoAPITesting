...
public class YandexSpellerAnswersArray {
    ...
    public String toString() {
        ...
        sb.append(YandexSpellerAnswersArray.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof YandexSpellerAnswersArray) == false) {
            return false;
        }
        YandexSpellerAnswersArray rhs = ((YandexSpellerAnswersArray) other);
